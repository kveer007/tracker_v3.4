...
class RemindersManager {
  constructor() {
    ...
    // Default data structure - UPDATED with protein interval support
    this.defaultData = {
      globalEnabled: false,
      systemNotifications: {
        waterAlert: {
  ...
  /**
   * Get system notification title - UPDATED with protein interval support
   */
  ...
  /**
   * Get system notification description - UPDATED with protein interval support
   */
  ...
  /**
   * Render system notification settings - UPDATED with protein interval support
   */
  renderSystemNotificationSettings(type, notification) {
    ...
    // Add interval setting for both water and protein intervals
    if ((type === 'waterInterval' || type === 'proteinInterval') && notification.interval) {
      settingsHtml += `
        <div class="setting-row">
  ...
  /**
   * Schedule system notification - UPDATED with protein interval support
   */
  scheduleSystemNotification(type) {
    ...
    if (type === 'waterInterval' || type === 'proteinInterval') {
  ...
  /**
   * Schedule interval notifications - UPDATED to handle both water and protein
   */
  ...
  /**
   * Trigger interval reminder - UPDATED to handle both water and protein
   */
